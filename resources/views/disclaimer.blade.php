...
@section('content')
    <div class="container">
        <div class="col-md-12"><div class="panel panel-default"><div class="panel-body"><div class="page-header" style="margin-top: -20px;"><h2 style="margin-bottom: -5px;">Disclaimer &amp; Privacy</h2></div> <p>
                    ...
                    </p> <h3>Intellectuele eigendomsrechten</h3> <p>
                    ...
                    </p> <h3>Beperking van aansprakelijkheid</h3> <p>
                        ...
                        Het is mogelijk dat de verkregen persoonsgegevens worden doorgegegeven aan de technische mensen van ActivismeBE. Uw persoonsgegevens niet worden doorgegeven worden aan derden. <br> <i>(Overheid valt niet onder derden)</i></p> <p>
                    ...
                    </p> <h3>Het gebruik van "cookies"</h3> <p>
                    ...
                    </p> <p>Door gebruik van onze website, gaat u akkoord met ons gebruik van cookies.</p> <h3>Google analytics</h3> <p>
